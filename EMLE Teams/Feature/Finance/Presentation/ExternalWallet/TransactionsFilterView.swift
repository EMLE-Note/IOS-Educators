...
enum DateFilterOptions: String, CaseIterable {
    case latest = "Latest"
    case oldest = "Oldest"
}

enum AmountFilterOptions: String, CaseIterable {
    case lowest = "lowest"
    case highest = "highest"
}

enum EnrollmentTypeFilterOptions: String, CaseIterable {
    case requestActivation = "Request activation"
    case automatedEnrollment = "Automated enrollment"
    case manualActivation = "Manual activation"
}

enum MaterialTypeFilterOptions: String, CaseIterable {
    case course = "Course"
...
struct TransactionsFilterView: View {
    @StateObject var viewModel: TransactionsFilterViewModel

    init(filters: Binding<TransactionFilterOptions>, closeAction: EmptyAction) {
        _viewModel = StateObject(wrappedValue: TransactionsFilterViewModel(filters: filters, closeAction: closeAction))
    }

    @FocusState var isMinTextFieldFocused: Bool
    @FocusState var isMaxTextFieldFocused: Bool
